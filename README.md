...
Predecir el abandono de clientes empresariales con 90 días de anticipación utilizando Big Data y Machine Learning.
...
**Entregables**:
Notebook con análisis descriptivo (EDA).
Visualizaciones: gráficos de distribución, correlaciones, segmentaciones.
Identificación de variables relevantes.
### Semana 5: Feature Engineering
- **Objetivo**: Crear nuevas variables (features) que potencien el modelo predictivo.
- **Entregables**:
Notebook con el proceso de ingeniería de variables.
Descripción de las nuevas features creadas.
Dataset final con variables predictivas.
### Semana 6: Machine Learning
- **Objetivo**: Entrenar y evaluar modelos de Machine Learning para predecir el churn.
- **Entregables**:
Notebook con entrenamiento de modelos (ej. Regresión logística, Random Forest, XGBoost).
...
- **Entregables**:
Dashboard en Power BI (o herramienta elegida).
...
- **Entregables**:
Informe final (PDF) con metodología, resultados y conclusiones.
Presentación final (PPTX).
Video de demostración del modelo y dashboard.
